...
proto.pb.Error.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    reasonList: jspb.Message.getRepeatedField(msg, 2)
  };
...
proto.pb.Device.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    keepmessages: jspb.Message.getFieldWithDefault(msg, 7, false),
    webhooksList: jspb.Message.getRepeatedField(msg, 8),
...
proto.pb.ListenerRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    request: (f = msg.getRequest()) && proto.pb.Request.toObject(includeInstance, f),
    filterdevicesList: jspb.Message.getRepeatedField(msg, 2),
    filtereventsList: jspb.Message.getRepeatedField(msg, 3)
  };
